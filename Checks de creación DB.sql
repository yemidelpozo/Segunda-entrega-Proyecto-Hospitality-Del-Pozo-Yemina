-- QUERIES PARA VERIFICAR LAS CREACIONES Y CHECKEAR LA CREACION DE CADA UNA
...
WHERE 
    TABLE_SCHEMA = 'reservas_actividades_hospitality';
...
WHERE 
    ROUTINE_SCHEMA = 'reservas_actividades_hospitality' 
...
WHERE 
    TRIGGER_SCHEMA = 'reservas_actividades_hospitality'
ORDER BY 
    EVENT_OBJECT_TABLE, 
    ACTION_TIMING, 
    EVENT_MANIPULATION;